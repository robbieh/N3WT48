...
Colors
------
Pass `color=NAME` or `hue=X` the URL.

Hue is a value from 0 to 360. Just play with it until you get the color you want.

Color is one of the following values:

```
[red, orange, yellow, chartreuse, green, spring, cyan, azure, blue, indigo, magenta, rose]
```
